...
<div class="box-body">
	...
	?>  
     ...
     <div class="form-group">
    	...
    	<label for="imgfile">
      	...
      	<!--預覽區塊-->  
      	<span class="txt_12_red">建議尺寸:520x520pix</span> 
    ...
    <div class="form-group">
     ...
     <div class="form-group">
    	...
    	<div class="col-md-10"> 
    	 <textarea name="description" id="description"  maxlength="37"><?=$rows["goods_item_description"]?></textarea>
    	 <span class="txt_12_gl1" style="position: relative; bottom: 7px;">說明：最多輸入37個字</span>
   	 	</div>
     </div>
