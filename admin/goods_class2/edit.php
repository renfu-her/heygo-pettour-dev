...
<div class="box-header txt_12"><span>|| 後台管理介面 ></span>修改商品類別</div>
...
<div class="text-center txt_title"><strong>修改商品類別
...
<div class="box-body">
	<div class="form-group">
     ...
     <div class="form-group">
   		<label class="col-md-2 control-label">內容介紹：</label>
    	<div class="col-md-10"> 
    	 <textarea name="description" id="description"><?=$rows["goods_class2_description"]; ?></textarea>
   	 	</div>
     </div>
     <!--按鈕-->
     <div  >
