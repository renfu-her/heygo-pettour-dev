...
<div class="text-center txt_title">網站資料設定</div>
<div class="box-body">
    ...
    <div class="form-group">
     ...
     <div class="form-group">
      ...
      <div class="form-group">
   		<label class="col-md-2 control-label">免運門檻：</label>
    	<div class="col-md-10">       
    	<input name="free_freight" type="number" id="free_freight" value="<?=$rows["free_freight"]; ?>" style="width: 80px; text-align: right;" required />元
    	 <DIV class="txt_12_gl1">說明：輸入滿額免運金額，輸入0代表全站免運。</DIV>
   	 	</div>
     </div>	
