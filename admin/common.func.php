...
//PHP_Mailer設定檔
		...
		$PHP_Mailer_setFrom_name="嘿狗!幫手作(系統發送通知信件，請勿直接回信)"; //寄件的Gmail
...
/* MySQL設定 */
define('DB_NAME','pettravel_heygo');
define('DB_USER','pettravel_heygo_dba');
define('DB_PASSWD','pettravel_heygo1397,!');
