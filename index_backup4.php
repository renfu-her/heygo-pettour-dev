...
<?PHP }//有訂購商品才顯示?>      
  ...
  <aside class="sidebar">
    <ul class="list-unstyled">
      <!--
      <li>
          <a href="https://www.facebook.com/enbiliving2018" target="_blank"><img class="side_ic" src="./img/side_ic01.png" alt="恩比Facebook官方粉絲團"></a>
      </li>
      //-->
...
$(function(){
   ...
   $('#get-map').on('click', function (e) {
       ...
       location.href="map.php?email="+email+"&client="+client+"&phone="+phone+"&note="+note+"&payment="+payment;
